...
questions = ["WhICH ONE IS THE OLDER PROGRAMMING LANGUAGE = ?","What is the Capital of Gujarat = ?","Which of the following is FRAMEWORK web development = ?","Which of the following is true for python? = ?","EXTENSION for python = ?"]
options = [['PYTHON','HTML','JAVA','CSS','PYTHON'],['MEHSANA','GANDHINAGAR','AHMEDABAD','SURAT','GANDHINAGAR'],
           ['HTML','CSS','ANGULARJS','PHP','ANGULARJS'],['print("Hello WORLD")','program("Hello World")','get("Hello world")','line("Hello World)','print("Hello WORLD")'],['.pi','.py','.pie','.o','.py']]
